...
%   v1.2 (05/27/19)
%   * bug fixes
%   * added back option for plotting
...
for iChr = 1:numChr
    ...
    if isempty(partParam.chrDivide) || strcmp(partParam.chrDivide,'yes')
