function [catmat]=padconcatenation_sr(a,b,c)
%[catmat]=padconcatenation_sr(a,b,c)
...
%
%Modified by Scott Ronquist, 2018.
%can now accept 3 dimensions
...
switch c
    ...
    case 3
        tempmat=NaN(max([sa(1) sb(1)]),max([sa(2) sb(2)]),sa(3)+sb(3));
        tempmat(1:sa(1),1:sa(2),1:sa(3))=a;
        tempmat(1:sb(1),1:sb(2),sa(3)+1:end)=b;
end
